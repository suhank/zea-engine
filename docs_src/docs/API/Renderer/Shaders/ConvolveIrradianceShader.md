---
id: "Renderer_Shaders_ConvolveIrradianceShader.ConvolveIrradianceShader"
title: "Class: ConvolveIrradianceShader"
sidebar_label: "ConvolveIrradianceShader"
...
- [`GLShader`](../Renderer_GLShader.GLShader)
  ...
  ↳ **`ConvolveIrradianceShader`**

## Constructors

### constructor

• **new ConvolveIrradianceShader**(`gl`)
...
| :------ | :------ | :------ |
| `gl` | `WebGL12RenderingContext` | The options value. |
...
[Renderer/Shaders/ConvolveIrradianceShader.ts:19](https://github.com/ZeaInc/zea-engine/blob/a43ac923/src/Renderer/Shaders/ConvolveIrradianceShader.ts#L19)
