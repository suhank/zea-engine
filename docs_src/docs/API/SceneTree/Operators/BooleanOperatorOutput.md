---
id: "SceneTree_Operators_OperatorOutput.BooleanOperatorOutput"
title: "Class: BooleanOperatorOutput"
sidebar_label: "BooleanOperatorOutput"
...
- [`OperatorOutput`](SceneTree_Operators_OperatorOutput.OperatorOutput)<`boolean`\>
...
• **new BooleanOperatorOutput**(`name`, `operatorOutputMode?`)
...
▸ **getParam**(): [`Parameter`](../Parameters/SceneTree_Parameters_Parameter.Parameter)<`boolean`\>

The getParam method.

#### Returns

[`Parameter`](../Parameters/SceneTree_Parameters_Parameter.Parameter)<`boolean`\>
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `param?` | [`Parameter`](../Parameters/SceneTree_Parameters_Parameter.Parameter)<`boolean`\> | `undefined` | The param value. |
