---
id: "SceneTree_Operators_OperatorOutput.Vec4OperatorOutput"
title: "Class: Vec4OperatorOutput"
sidebar_label: "Vec4OperatorOutput"
...
- [`OperatorOutput`](SceneTree_Operators_OperatorOutput.OperatorOutput)<[`Vec4`](../../Math/Math_Vec4.Vec4)\>
...
• **new Vec4OperatorOutput**(`name`, `operatorOutputMode?`)
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `param?` | [`Parameter`](../Parameters/SceneTree_Parameters_Parameter.Parameter)<[`Vec4`](../../Math/Math_Vec4.Vec4)\> | `undefined` | The param value. |
