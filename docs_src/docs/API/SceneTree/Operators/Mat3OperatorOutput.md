---
id: "SceneTree_Operators_OperatorOutput.Mat3OperatorOutput"
title: "Class: Mat3OperatorOutput"
sidebar_label: "Mat3OperatorOutput"
...
- [`OperatorOutput`](SceneTree_Operators_OperatorOutput.OperatorOutput)<[`Mat3`](../../Math/Math_Mat3.Mat3)\>
...
• **new Mat3OperatorOutput**(`name`, `operatorOutputMode?`)
...
| Name | Type | Default value | Description |
| :------ | :------ | :------ | :------ |
| `param?` | [`Parameter`](../Parameters/SceneTree_Parameters_Parameter.Parameter)<[`Mat3`](../../Math/Math_Mat3.Mat3)\> | `undefined` | The param value. |
