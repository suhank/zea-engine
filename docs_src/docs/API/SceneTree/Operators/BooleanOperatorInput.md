---
id: "SceneTree_Operators_OperatorInput.BooleanOperatorInput"
title: "Class: BooleanOperatorInput"
sidebar_label: "BooleanOperatorInput"
...
- [`OperatorInput`](SceneTree_Operators_OperatorInput.OperatorInput)<`boolean`\>
...
• `Optional` **param**: [`Parameter`](../Parameters/SceneTree_Parameters_Parameter.Parameter)<`boolean`\>
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `param?` | [`Parameter`](../Parameters/SceneTree_Parameters_Parameter.Parameter)<`boolean`\> | The param value. |
