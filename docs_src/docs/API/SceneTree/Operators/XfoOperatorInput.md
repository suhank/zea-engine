---
id: "SceneTree_Operators_OperatorInput.XfoOperatorInput"
title: "Class: XfoOperatorInput"
sidebar_label: "XfoOperatorInput"
...
- [`OperatorInput`](SceneTree_Operators_OperatorInput.OperatorInput)<[`Xfo`](../../Math/Math_Xfo.Xfo)\>
...
• `Optional` **param**: [`Parameter`](../Parameters/SceneTree_Parameters_Parameter.Parameter)<[`Xfo`](../../Math/Math_Xfo.Xfo)\>
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `param?` | [`Parameter`](../Parameters/SceneTree_Parameters_Parameter.Parameter)<[`Xfo`](../../Math/Math_Xfo.Xfo)\> | The param value. |
