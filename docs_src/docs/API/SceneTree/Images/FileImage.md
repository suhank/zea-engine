---
id: "SceneTree_Images_FileImage.FileImage"
title: "Class: FileImage"
sidebar_label: "FileImage"
...
- [`BaseImage`](../SceneTree_BaseImage.BaseImage)
  ...
  ↳↳ [`FileImage2D`](SceneTree_Images_FileImage.FileImage2D)

  ↳↳ [`GIFImage`](SceneTree_Images_GIFImage.GIFImage)

  ↳↳ [`LDRImage`](SceneTree_Images_LDRImage.LDRImage)

  ↳↳ [`LDRVideo`](SceneTree_Images_LDRVideo.LDRVideo)

## Constructors

### constructor

• **new FileImage**(`name?`, `filePath?`, `params?`)
...
[SceneTree/Images/FileImage.ts:22](https://github.com/ZeaInc/zea-engine/blob/a43ac923/src/SceneTree/Images/FileImage.ts#L22)
...
[SceneTree/Images/FileImage.ts:63](https://github.com/ZeaInc/zea-engine/blob/a43ac923/src/SceneTree/Images/FileImage.ts#L63)
