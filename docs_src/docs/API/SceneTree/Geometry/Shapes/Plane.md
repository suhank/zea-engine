---
id: "SceneTree_Geometry_Shapes_Plane.Plane"
title: "Class: Plane"
sidebar_label: "Plane"
...
• **new Plane**(`SizeX?`, `SizeY?`, `DetailX?`, `DetailY?`, `addNormals?`, `addTextureCoords?`)
...
| :------ | :------ | :------ | :------ |
| `SizeX` | `number` | `1.0` | The length of the plane along the X axis. |
| `SizeY` | `number` | `1.0` | The length of the plane along the Y axis. |
| `DetailX` | `number` | `1` | The number of divisions along the X axis. |
| `DetailY` | `number` | `1` | The number of divisions along the Y axis. |
| `addNormals` | `boolean` | `true` | The addNormals value. |
| `addTextureCoords` | `boolean` | `true` | The addTextureCoords value. |
...
[src/SceneTree/Geometry/Shapes/Plane.ts:53](https://github.com/ZeaInc/zea-engine/blob/22cb841fb/src/SceneTree/Geometry/Shapes/Plane.ts#L53)
...
• **detailXParam**: [`NumberParameter`](../../Parameters/SceneTree_Parameters_NumberParameter.NumberParameter)

**`member`** detailXParam - Length of the plane along `X` axis.

#### Defined in

[src/SceneTree/Geometry/Shapes/Plane.ts:26](https://github.com/ZeaInc/zea-engine/blob/22cb841fb/src/SceneTree/Geometry/Shapes/Plane.ts#L26)

___

### detailYParam

• **detailYParam**: [`NumberParameter`](../../Parameters/SceneTree_Parameters_NumberParameter.NumberParameter)

**`member`** detailYParam - Length of the plane along `Y` axis.

#### Defined in

[src/SceneTree/Geometry/Shapes/Plane.ts:31](https://github.com/ZeaInc/zea-engine/blob/22cb841fb/src/SceneTree/Geometry/Shapes/Plane.ts#L31)
...
[src/SceneTree/Geometry/Shapes/Plane.ts:36](https://github.com/ZeaInc/zea-engine/blob/22cb841fb/src/SceneTree/Geometry/Shapes/Plane.ts#L36)
...
[src/SceneTree/Geometry/Shapes/Plane.ts:41](https://github.com/ZeaInc/zea-engine/blob/22cb841fb/src/SceneTree/Geometry/Shapes/Plane.ts#L41)
...
[src/SceneTree/Geometry/Shapes/Plane.ts:73](https://github.com/ZeaInc/zea-engine/blob/22cb841fb/src/SceneTree/Geometry/Shapes/Plane.ts#L73)
...
[src/SceneTree/Geometry/Shapes/Plane.ts:123](https://github.com/ZeaInc/zea-engine/blob/22cb841fb/src/SceneTree/Geometry/Shapes/Plane.ts#L123)
