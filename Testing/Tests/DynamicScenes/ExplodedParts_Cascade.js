testingHarness.registerTest('DynamicScenes/ExplodedParts_Cascade', (domElement, resources)=> {
    
    const Z = ZeaEngine;

    const scene = new Z.Scene(resources);
    scene.getResourceLoader().addResourceURL("/Assets/ExplodePartA.obj");
    scene.getResourceLoader().addResourceURL("/Assets/ExplodePartB.obj");
    ...
    // Obj Asset
    {
        ...
        objAsset.getParameter('ObjFilePath').setUrl("https://storage.googleapis.com/zea-playground-assets/zea-engine/ExplodePartA.obj");
...

    {
        ...
        objAsset.getParameter('ObjFilePath').setUrl("https://storage.googleapis.com/zea-playground-assets/zea-engine/ExplodePartB.obj");
        objAsset.getParameter('splitObjects').setValue(false);
        objAsset.getParameter('splitGroupsIntoObjects').setValue(false);
        objAsset.getParameter('loadMtlFile').setValue(false);
        objAsset.getParameter('defaultShader').setValue('SimpleSurfaceShader');
