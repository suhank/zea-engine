...
testingHarness.registerTest('Geometry/PrimitiveShapes', (domElement, resources) => {
  ...
  linesMaterial.getParameter('BaseColor').setValue(new Color(1.0, 0.3, 0.4))
  ...
  pointsMaterial.getParameter('BaseColor').setValue(new Color(1.0, 0.3, 0.4))
  ...
  renderer.getViewport().addListener('pointerDownOnGeom', (event) => {
