...
testingHarness.registerTest('Geometry/Points/2Points', (domElement, resources) => { 
    const Z = ZeaEngine;
    ...
    renderer.getViewport().getCamera().setPositionAndTarget(new Z.Vec3(2.0, 5.0, 1.0), new Z.Vec3(0.0, 0.0, 0.0));
...
testingHarness.registerTest('Geometry/Points/PointCloud', (domElement, resources) => {
    const Z = ZeaEngine;
    const scene = new Z.Scene(resources);
    scene.setupGrid(6, 6);
