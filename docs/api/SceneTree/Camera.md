...
* [Camera ⇐ <code>TreeItem</code>](#Camera)
    ...
    * [setFov(value)](#setFov)
    * [getFrustumHeight() ⇒ <code>number</code>](#getFrustumHeight)
    * [setFrustumHeight(value)](#setFrustumHeight)
...
| Param | Type | Description |
| --- | --- | --- |
| value | <code>number</code> | The new FOV value. |

<a name="Camera+getFrustumHeight"></a>
...
**Returns**: <code>number</code> - - Returns the Frustum Height value.  
<a name="Camera+setFrustumHeight"></a>
...
| Param | Type | Description |
| --- | --- | --- |
| value | <code>number</code> | The new Frustum Height value. |
