...
- [`BaseClass`](Utilities_BaseClass.BaseClass)
  ...
  ↳↳ [`AssetLoadContext`](../SceneTree/SceneTree_AssetItem.AssetLoadContext)
...
[Utilities/EventEmitter.ts:33](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/Utilities/EventEmitter.ts#L33)
...
[BaseClass](Utilities_BaseClass.BaseClass).[fromJSON](Utilities_BaseClass.BaseClass#fromjson)
...
[BaseClass](Utilities_BaseClass.BaseClass).[toJSON](Utilities_BaseClass.BaseClass#tojson)
