---
id: "SceneTree_Operators_RouterOperator.RouterOperator"
title: "Class: RouterOperator"
sidebar_label: "RouterOperator"
...
[SceneTree/Operators/RouterOperator.ts:18](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Operators/RouterOperator.ts#L18)
...
• **\_\_input**: [`OperatorInput`](SceneTree_Operators_OperatorInput.OperatorInput)

#### Defined in

[SceneTree/Operators/RouterOperator.ts:12](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Operators/RouterOperator.ts#L12)
...
▸ **addRoute**(`param`): [`OperatorOutput`](SceneTree_Operators_OperatorOutput.OperatorOutput)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `param` | [`Parameter`](../Parameters/SceneTree_Parameters_Parameter.Parameter)<`unknown`\> | The parameter to router values to. |
...
[SceneTree/Operators/RouterOperator.ts:28](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Operators/RouterOperator.ts#L28)
...
[SceneTree/Operators/RouterOperator.ts:39](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Operators/RouterOperator.ts#L39)
