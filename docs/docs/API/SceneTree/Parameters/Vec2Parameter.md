---
id: "SceneTree_Parameters_Vec2Parameter.Vec2Parameter"
title: "Class: Vec2Parameter"
sidebar_label: "Vec2Parameter"
...
- [`Parameter`](SceneTree_Parameters_Parameter.Parameter)<[`Vec2`](../../Math/Math_Vec2.Vec2)\>
...
• **new Vec2Parameter**(`name?`, `value?`, `range?`)
...
| :------ | :------ | :------ | :------ |
| `name` | `string` | `''` | The name of the Vec2 parameter. |
| `value?` | [`Vec2`](../../Math/Math_Vec2.Vec2) | `undefined` | The value of the parameter. |
| `range?` | [`Vec2`](../../Math/Math_Vec2.Vec2)[] | `undefined` | The range value is an array of two `Vec2` objects. |
...
[SceneTree/Parameters/Vec2Parameter.ts:34](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/Vec2Parameter.ts#L34)
...
• **\_\_value**: [`Vec2`](../../Math/Math_Vec2.Vec2)
...
• `Protected` `Optional` **range**: [`Vec2`](../../Math/Math_Vec2.Vec2)[]

#### Defined in

[SceneTree/Parameters/Vec2Parameter.ts:25](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/Vec2Parameter.ts#L25)
...
▸ **clone**(): [`Vec2Parameter`](SceneTree_Parameters_Vec2Parameter.Vec2Parameter)
...
[SceneTree/Parameters/Vec2Parameter.ts:91](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/Vec2Parameter.ts#L91)
...
[SceneTree/Parameters/Vec2Parameter.ts:77](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/Vec2Parameter.ts#L77)
...
▸ **getRange**(): [`Vec2`](../../Math/Math_Vec2.Vec2)[]
...
[SceneTree/Parameters/Vec2Parameter.ts:44](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/Vec2Parameter.ts#L44)
...
▸ **getValueFromOp**(`index`): [`Vec2`](../../Math/Math_Vec2.Vec2)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | [`Vec2`](../../Math/Math_Vec2.Vec2) | The context value. |
...
[SceneTree/Parameters/Vec2Parameter.ts:66](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/Vec2Parameter.ts#L66)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | [`Vec2`](../../Math/Math_Vec2.Vec2) | The computed value to be stored in the Parameter. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `range` | [`Vec2`](../../Math/Math_Vec2.Vec2)[] | The range value. |
...
[SceneTree/Parameters/Vec2Parameter.ts:54](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/Vec2Parameter.ts#L54)
...
[SceneTree/Parameters/Vec2Parameter.ts:70](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/Vec2Parameter.ts#L70)
