...
class GLBillboardsPass extends GLPass {
  ...
  __populateBillboardDataArray(billboardData, index, dataArray) {
    ...
    const col0 = Vec4.createFromBuffer(dataArray.buffer, offset)
    const col1 = Vec4.createFromBuffer(dataArray.buffer, offset + 4)
    const col2 = Vec4.createFromBuffer(dataArray.buffer, offset + 8)
    const col3 = Vec4.createFromBuffer(dataArray.buffer, offset + 12)
    ...
    const col4 = Vec4.createFromBuffer(dataArray.buffer, offset + 16)
