...
float SobelSampleDepth(vec2 uv, vec3 offset)
{
    ...
    float outlineSensitivity =  (1.0 / pixelCenter) * outlineDepthMultiplier;

    return SobelDepth(pixelCenter, pixelLeft, pixelRight, pixelUp, pixelDown) * outlineSensitivity;
}
...
void main(void) {
    ...
    float minEdgeValue = 0.35;
    sobelDepth = clamp(sobelValue > minEdgeValue ? sobelValue : 0.0, 0.0, 1.0);
