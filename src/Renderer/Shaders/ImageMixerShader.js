...
class ImageMixerShader extends GLShader {
    ...
    constructor(gl) {
        super(gl);
        this.__shaderStages['VERTEX_SHADER'] = shaderLibrary.parseShader('ImageMixerShader.vertexShader', `
...
`);
        this.__shaderStages['FRAGMENT_SHADER'] = shaderLibrary.parseShader('ImageMixerShader.fragmentShader', `
precision highp float;
