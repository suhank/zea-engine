...
class Vec2 extends AttrValue {
   ...
   */
  constructor(x: number | Float32Array | Uint32Array | Record<string, any> = 0, y = 0) {
    super()
  ...
  /**
   * Returns the number of Float32 elements used by this type. Used to calculate storage requirements
   * for large arrays of this type.
   *
