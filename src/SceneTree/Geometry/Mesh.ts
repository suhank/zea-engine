...
class Mesh extends BaseGeom {
  protected __edgeAttributes: Map<string, any>
  protected __faceAttributes: Map<string, any>
  protected __faceCounts: any[]
  protected __faceVertexIndices: TypedArray
  protected __logTopologyWarnings: boolean
  edgeAngles: Float32Array
  edgeFaces: any
  edgeVecs: any
  edgeVerts: any
  faceEdges: any
   ...
   */
  addVertexAttribute(name: string, dataType: AttrValue | number, defaultScalarValue?: number): VertexAttribute {
   ...
   */
  addFaceAttribute(name: string, dataType: AttrValue | number, count?: number | TypedArray): Attribute {
   ...
   */
  addEdgeAttribute(name: string, dataType: AttrValue | number, count?: number | TypedArray): Attribute {
   ...
   */
  getEdgeAttribute(name: string): Attribute {
   ...
   */
  computeVertexNormals(hardAngle = 1.0 /* radians */): VertexAttribute {
