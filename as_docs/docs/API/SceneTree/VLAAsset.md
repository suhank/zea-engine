...
[SceneTree/VLAAsset.ts:22](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/VLAAsset.ts#L22)
...
| `context` | [`AssetLoadContext`](SceneTree_AssetItem.AssetLoadContext) | The load context object that provides additional data such as the units of the scene we are loading into. |
...
[SceneTree/VLAAsset.ts:73](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/VLAAsset.ts#L73)
...
[SceneTree/VLAAsset.ts:43](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/VLAAsset.ts#L43)
