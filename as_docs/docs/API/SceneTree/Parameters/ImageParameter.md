---
id: "SceneTree_Parameters_ImageParameter.ImageParameter"
title: "Class: ImageParameter"
sidebar_label: "ImageParameter"
...
- [`Parameter`](SceneTree_Parameters_Parameter.Parameter)<[`BaseImage`](../SceneTree_BaseImage.BaseImage) \| `undefined`\>
...
| :------ | :------ | :------ | :------ |
| `name` | `string` | `''` | The name of the image parameter. |
| `value?` | [`BaseImage`](../SceneTree_BaseImage.BaseImage) | `undefined` | The value of the parameter. |
...
[SceneTree/Parameters/ImageParameter.ts:28](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/ImageParameter.ts#L28)
...
• **\_\_value**: [`BaseImage`](../SceneTree_BaseImage.BaseImage)
...
▸ **clone**(): [`ImageParameter`](SceneTree_Parameters_ImageParameter.ImageParameter)
...
- Returns a new cloned image parameter.
...
[SceneTree/Parameters/ImageParameter.ts:77](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/ImageParameter.ts#L77)
...
[SceneTree/Parameters/ImageParameter.ts:61](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/ImageParameter.ts#L61)
...
▸ **getValue**(): [`BaseImage`](../SceneTree_BaseImage.BaseImage)
...
▸ **getValueFromOp**(`index`): [`BaseImage`](../SceneTree_BaseImage.BaseImage)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | [`BaseImage`](../SceneTree_BaseImage.BaseImage) | The context value. |
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `value` | [`BaseImage`](../SceneTree_BaseImage.BaseImage) | The computed value to be stored in the Parameter. |
...
[SceneTree/Parameters/ImageParameter.ts:41](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/SceneTree/Parameters/ImageParameter.ts#L41)
