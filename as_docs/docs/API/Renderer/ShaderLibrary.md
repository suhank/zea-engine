...
▸ **getMaterialTemplate**(`shaderName`): [`Material`](../SceneTree/SceneTree_Material.Material)
...
[Renderer/ShaderLibrary.ts:57](https://github.com/ZeaInc/zea-engine/blob/d2f20572/src/Renderer/ShaderLibrary.ts#L57)
