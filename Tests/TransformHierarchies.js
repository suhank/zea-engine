...
testingHarness.registerTest('TransformHierarchies', (domElement, resources)=> {
    ...
    geomItem1.setLocalXfo(new Visualive.Xfo(new Visualive.Vec3(0,0,2), new Visualive.Quat({'rotateX':Math.degToRad(90)})));
    geomItem0.addChild(geomItem1);

    let geomItem2 = new Visualive.GeomItem('Item2', cuboid, material);
    geomItem2.setLocalXfo(new Visualive.Xfo(new Visualive.Vec3(0,0,2), new Visualive.Quat({'rotateX':Math.degToRad(90)})));
